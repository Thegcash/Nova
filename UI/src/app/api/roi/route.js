...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      hasExposures: exp.rowCount > 0, hasLosses: loss.rowCount > 0,
      roi_kpis: { savings_estimate: exp.rowCount && loss.rowCount ? 125000 : 0, payback_days: exp.rowCount && loss.rowCount ? 87 : null, loss_ratio_trend: [] }
    });
  } catch (e) {
